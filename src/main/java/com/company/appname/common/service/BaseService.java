package com.company.appname.common.service;
...
import com.company.appname.common.util.ConvertUtil;
import com.company.appname.common.util.ObjectUtil;
...
public abstract class BaseService<R extends SoftDeleteRepository, E extends BaseEntity> {
    ...
    protected <T, K> K save(T createDTO, Class<K> clazz) throws Exception {
        ...
        return convertUtil.convert(repository.saveAndFlush(entity), clazz);
    }
